...
let wrappedAddParticipant = mochaPlugin.getWrapper('addParticipantOneTimeEvent', './../../oneTimeEvents/addParticipant.js', 'main')

describe('Participant OneTimeEvent', () => {
  let HashKey
  let RangeKey
  ...
  it('Read OneTimeEvent: 0 Participant', () => {
    return wrappedGet.run({
      ...
      expect(response).to.not.be.empty
      expect(response.statusCode).to.equal(200)
      expect(body.Participants.length).to.equal(0)
    })
  })

  it('Add Participant OneTimeEvent', () => {
